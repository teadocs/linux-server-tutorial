...
![nginx介绍1](/static/images/nginx_1.png)

**客户端必须设置正向代理服务器**，当然前提是要知道正向代理服务器的IP地址，还有代理程序的端口。如图。

![nginx介绍2](/static/images/nginx_2.png)
...
![nginx介绍3](/static/images/nginx_3.png)
...
![nginx介绍4](/static/images/nginx_4.png)
...
![nginx介绍5](/static/images/nginx_5.png)
